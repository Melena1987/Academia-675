...
const Sponsors: React.FC = () => {
  ...
  const partners = [
    {
      img: "https://firebasestorage.googleapis.com/v0/b/galeriaoficialapp.firebasestorage.app/o/users%2FI5KZz4BuUEfxcoAvSCAWllkQtwt1%2Fphotos%2F1766739387262_ausol-23_400x400.jpg?alt=media&token=0f8f2112-e794-4281-9cdb-33fa0e416642",
      url: "https://www.autopistadelsol.com/"
    },
    {
      img: "https://firebasestorage.googleapis.com/v0/b/galeriaoficialapp.firebasestorage.app/o/users%2FI5KZz4BuUEfxcoAvSCAWllkQtwt1%2Fphotos%2F1766739387262_Captura-de-pantalla-2016-01-28-a-las-19.00.55_400x400.jpg?alt=media&token=bd8e03c7-b3aa-45ce-a448-e7583b5216f8",
      url: "https://www.endesa.com/"
    },
    {
      img: "https://firebasestorage.googleapis.com/v0/b/galeriaoficialapp.firebasestorage.app/o/users%2FI5KZz4BuUEfxcoAvSCAWllkQtwt1%2Fphotos%2F1766739387262_images_400x400.png?alt=media&token=c965d757-3ae7-40c3-8bad-791af301cd2c",
      url: "https://www.holidayworld.es/"
    },
    {
    ...
    },
    {
      ...
      url: "https://sanamar.es/"
    },
    {
      img: "https://firebasestorage.googleapis.com/v0/b/galeriaoficialapp.firebasestorage.app/o/users%2FI5KZz4BuUEfxcoAvSCAWllkQtwt1%2Fphotos%2F1766739387262_images-2_400x400.png?alt=media&token=adf7bbff-70d3-47de-97a3-45c1160379b0",
      url: "https://www.decathlon.es/"
    },
    {
      img: "https://firebasestorage.googleapis.com/v0/b/galeriaoficialapp.firebasestorage.app/o/users%2FI5KZz4BuUEfxcoAvSCAWllkQtwt1%2Fphotos%2F1766739387262_logo-QUIRON-SALUD_400x400.webp?alt=media&token=4325e840-5ae1-46c1-aa4a-ff29698f224d",
    ...
    },
    {
      ...
      url: "https://proyecto675.com/"
    },
    {
      img: "https://firebasestorage.googleapis.com/v0/b/galeriaoficialapp.firebasestorage.app/o/users%2FI5KZz4BuUEfxcoAvSCAWllkQtwt1%2Fphotos%2F1766739387262_mapfre_2_400x400.png?alt=media&token=a3078b11-cce6-4cef-b203-6d2201fc8d86",
    ...
    <section className="py-24 bg-gray-50 overflow-hidden border-t border-gray-100">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <div className="flex flex-col items-center mb-24">
          <a 
            href="https://www.fundacionunicaja.com/" 
            target="_blank" 
            rel="noopener noreferrer" 
            className="group relative w-full max-w-2xl block"
          >
             ...
             <div className="relative px-12 md:px-24 py-12 bg-white rounded-[3rem] border border-gray-100 shadow-2xl flex flex-col items-center justify-center transition-all group-hover:translate-y-[-8px] group-hover:shadow-[0_40px_80px_-15px_rgba(0,0,0,0.1)]">
                <img 
                  ...
                  className="h-32 md:h-48 w-auto object-contain mb-8 transition-transform duration-500 group-hover:scale-105"
                />
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-6 md:gap-8 items-center">
           {partners.map((partner, i) => {
             const isWhiteLogo = partner.img.includes('logodark-blanco');
             return (
               <a 
                 key={i} 
                 href={partner.url} 
                 target="_blank" 
                 rel="noopener noreferrer" 
                 className="h-32 md:h-40 flex items-center justify-center bg-white border border-gray-100 rounded-3xl p-6 transition-all shadow-sm hover:shadow-xl hover:border-orange-500/20 group overflow-hidden"
               >
                  <img 
                    src={partner.img} 
